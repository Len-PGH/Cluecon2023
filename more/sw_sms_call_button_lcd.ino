...
const char * ssid = "cluecon2023";
const char * password = "cluecon.com";
...
void loop() {
  ...
  lcd.setCursor(0, 0);
  lcd.print("Temperature: ");   // Print "Hello," on the first line
  lcd.setCursor(0, 1);
  lcd.print(temperatureF); // Print the temperature value on the second line
  lcd.print("F");
 ...
 //     bool smsResult = sendSMS("Button pushed on ESP32. Thank you for choosing https://signalwire.com"); //uncomment to send sms
